...
car = pygame.Rect(WIDTH // 2, HEIGHT - CAR_HEIGHT, CAR_WIDTH, CAR_HEIGHT)  # Colocar el coche en la parte inferior de la pantalla
...
ROAD_WIDTH = WIDTH
ROAD_HEIGHT = HEIGHT  # Hacer que la carretera ocupe toda la altura de la ventana
road = pygame.Rect(0, 0, ROAD_WIDTH, ROAD_HEIGHT)
...
def draw_window():
    ...
    for power_up in POWER_UPS:
        pygame.draw.rect(win, (255,255,0), power_up)  # Dibujar los power-ups

    # Dibujar la puntuación y los puntos restantes en la esquina superior izquierda
    score_text = font.render(f"Score: {score}", True, (255, 255, 255))
    points_text = font.render(f"Life: {points}", True, (255, 255, 255))
